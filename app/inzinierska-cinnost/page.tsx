...
export default function InzinierskaCinnostPage() {
  return (
    <main className="min-h-screen bg-black text-white/85 selection:bg-white selection:text-black">
      {/* Hero Section */}
      <section id="domov" className="relative h-[60vh] md:h-[70vh] w-full flex items-center justify-center overflow-hidden">
        <NavbarInzinierska />
        ...
        <div className="relative z-10 text-center px-4 max-w-5xl mx-auto mt-16 md:mt-16">
